          ...
          <div className={splitClasses}>
            ...
            <div className="split-item">
              ...
              <div className={
                ...
                <Image
                  src={require('./../../assets/images/crawled-data.PNG')}
                  alt="Vietnam crawled data"
                  width={528}
                  height={396} />
              </div>
            </div>
            ...
            <div className="split-item">
              ...
              <div className={
                ...
                data-reveal-container=".split-item">
                <Image
                  src={require('./../../assets/images/seaborn.PNG')}
                  alt="A variety of data"
                  width={528}
                  height={396} />
              </div>
            </div>
            ...
            <div className="split-item">
              <div className="split-item-content center-content-mobile reveal-from-left" data-reveal-container=".split-item">
                ...
                <p className="m-0">
                    Our goal is to provide a <b>stable</b> API endpoint which can be fetched <i>hourly/daily/monthly/annually</i> for other projects 
                </p>
              </div>
              <div className={
                classNames(
